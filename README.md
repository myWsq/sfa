...
- 当前已经具备 committed benchmark dataset、machine-readable baseline，以及阶段级/资源级 benchmark 观测；主要收口项转向 CLI 回归覆盖与更完整的回归资产
...
- 以仓库中的测试、smoke checks、benchmark dry-run 和按需刷新的 committed benchmark baseline 作为发版前质量闸口
